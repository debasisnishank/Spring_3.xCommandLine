...
public class Ex8 {
     public static void main(String[] args) {
          ApplicationContext scc = (ApplicationContext) new AnnotationConfigApplicationContext(Conf.class);
          EmployeeDaoImp e = (EmployeeDaoImp) scc.getBean(com.db.EmployeeDaoImp.class);
